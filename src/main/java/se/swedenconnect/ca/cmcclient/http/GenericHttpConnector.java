...
package se.swedenconnect.ca.cmcclient.http;
...
public class GenericHttpConnector {
  ...
  public GenericHttpConnector(int defaultConnectTimeout, int defaultReadTimeout) {
   ...
   */
  public HttpResponse getResource(URL requestUrl){
    return getResource(requestUrl, this.defaultConnectTimeout, this.defaultReadTimeout);
  }
  ...
  public HttpResponse getResource(URL requestUrl, int connectTimeout, int readTimeout){
    return getResource(requestUrl, null, null, connectTimeout, readTimeout);
  }
   ...
   * @return response data
   */
  public HttpResponse getResource(URL requestUrl, byte[] data, Map<String, String> propertyMap){
    return getResource(requestUrl, data, propertyMap, this.defaultConnectTimeout, this.defaultReadTimeout);
   ...
   * @return response data
   */
  public HttpResponse getResource(URL requestUrl, byte[] data, Map<String, String> propertyMap, int connectTimeout, int readTimeout){
    try {
